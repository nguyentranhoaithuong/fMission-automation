...
public class UTCC033 {
    ...
    public void Test() {
        ...
        softAssert.assertEquals(caLamPage.toastMessageText(),"Chúc mừng bạn đã hoàn thành nhiệm vụ!");
        caLamPage.closeToastMessage();
        softAssert.assertTrue(caLamPage.isCheckMark(3),"Chưa đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(caLamPage.getPhanTramHoanThanh(),"60%");
