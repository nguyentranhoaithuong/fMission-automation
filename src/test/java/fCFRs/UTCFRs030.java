...
//        driver.quit();
    ...
    @Test
    public void Test() {
//      Xác minh rằng thực hiện nhiệm vụ 4 thất bại khi user tạo mới sản phẩm đổi quà không thành công
        ...
        softAssert.assertTrue(cuaHangPage.isErrorMessageChecked());
        softAssert.assertEquals(cuaHangPage.getErrorMessage(), "Chưa nhập tên sản phẩm!");
        cuaHangPage.closeErrorMessage();
        softAssert.assertFalse(cuaHangPage.isCheckMark(4), "Đã đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(cuaHangPage.getPhanTramHoanThanh(),"60%");
