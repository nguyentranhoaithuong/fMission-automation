...
public class UTCFRs022 {
    ...
    public void Test() {
        ...
        softAssert.assertTrue(tieuChiGhiNhanPage.isErrorMessageChecked());
        softAssert.assertEquals(tieuChiGhiNhanPage.getErrorMessage(),"Bạn cần nhập tiêu chí ghi nhận!");
        tieuChiGhiNhanPage.closeErrorMessage();
        softAssert.assertFalse(tieuChiGhiNhanPage.isCheckMark(2),"Đã đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(tieuChiGhiNhanPage.getPhanTramHoanThanh(),"20%");
