...
public class UTKH021 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 2 thành công khi user tạo mới nhóm công việc thành công
        Allure.step("Truy cap module Ke hoach");
        homePage.clickFPlanModule();
        fPlanPage.openBangNhiemVu();
        fPlanPage.clickArrowForwardButton(2);
        fPlanPage.clickTaoNhomCongViecButton();
        ...
        fPlanPage.openBangNhiemVu();
        softAssert.assertTrue(fPlanPage.isNhomCongViecMoiDisplayed());
        softAssert.assertTrue(fPlanPage.isCheckMark(2),"Chưa đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(fPlanPage.getPhanTramHoanThanh(),"40%");
