...
public class UTKH022 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 3 thành công khi user tạo mới nhóm công việc thành công
        Allure.step("Truy cap module Ke hoach");
        homePage.clickFPlanModule();
        fPlanPage.openBangNhiemVu();
        fPlanPage.clickArrowForwardButton(3);
        fPlanPage.clickThemCongViecButton();
        ...
        softAssert.assertTrue(fPlanPage.isCongViecVuaTaoDisplayed());
        fPlanPage.openBangNhiemVu();
        softAssert.assertTrue(fPlanPage.isCheckMark(3),"Chưa đánh dấu hoành thành nhiệm vụ");
