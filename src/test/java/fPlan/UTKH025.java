...
public class UTKH025 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 4 thành công khi user tạo mới todolist liên kết thành công
        ...
        softAssert.assertEquals(fPlanPage.getTenTodolist(thoiGian),tenCongViec);
        fPlanPage.clickDongChiTietCongViec();
        fPlanPage.openBangNhiemVu();
        softAssert.assertTrue(fPlanPage.isCheckMark(4),"Chưa đánh dấu hoành thành nhiệm vụ");
