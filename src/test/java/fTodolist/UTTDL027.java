...
public class UTTDL027 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 2 thành công khi user Nộp Todolist danh sách
        Allure.step("Truy cap module Todolist");
        homePage.clickFTodolistModule();
        fTodolistPage.openDanhSachTab();
        fTodolistPage.openDateChuaNopToDoList();
        fTodolistPage.clickNopTodolistButton();
        ...
        softAssert.assertTrue(fTodolistPage.isCheckMark(2),"Chưa đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(fTodolistPage.getPhanTramHoanThanh(),"40%");
