...
public class UTTDL035 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 3 thành công khi user Báo cáo todolist dạng danh sách
        Allure.step("Truy cap module Todolist");
        homePage.clickFTodolistModule();
        fTodolistPage.openDanhSachTab();
        fTodolistPage.OpenDateChuaBaoCaoTodolist();
        fTodolistPage.selectTinhTrangCongViec("Done");
