...
public class UTWF027 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 3 không thành công khi user chưa kéo thả thẻ công việc
        ...
        fWorkflowPage.xoaMainPath();
        fWorkflowPage.keoThaCongViec();
        fWorkflowPage.clickXuatBanButton();
        softAssert.assertTrue(fWorkflowPage.isErrorMessageChecked());
        softAssert.assertEquals(fWorkflowPage.getErrorMessage(),"Phải có tối thiểu một bước công việc liên kết với thẻ bắt đầu!");
        fWorkflowPage.closeErrorMessage();
        fWorkflowPage.clickThuGonButton();
        fWorkflowPage.openBangNhiemVu();
        softAssert.assertFalse(fWorkflowPage.isCheckMark(3),"Đã đánh dấu hoành thành nhiệm vụ");
