...
public class UTWF030 {
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 4 thất bại khi user tạo nhiệm vụ không thành công
        ...
        softAssert.assertEquals(fWorkflowPage.getErrorMessage(),"Bạn chưa nhập Tên nhiệm vụ!");
        fWorkflowPage.closeErrorMessage();
        fWorkflowPage.dongPopupTaoCongViec();
        fWorkflowPage.openBangNhiemVu();
        softAssert.assertFalse(fWorkflowPage.isCheckMark(4),"Đã đánh dấu hoành thành nhiệm vụ");
