...
public class UTWF020 {
    WebDriver driver;
    LoginPage loginPage;
    HomePage homePage;
    fWorkflowPage fWorkflowPage;
    Faker faker;
    ...
    public void initData() {
        ...
        tenQuyTrinh = faker.company().buzzword();
    }
    @AfterMethod
    public void cleanUp() {
        driver.quit();
    ...
    @Test
    public void Test() {
        //Xác minh rằng thực hiện nhiệm vụ 1 thành công khi user tạo mới quy trình thành công
        ...
        softAssert.assertTrue(fWorkflowPage.isQuyTrinhVuaTaoDisplayed(tenQuyTrinh));
        softAssert.assertTrue(fWorkflowPage.isCheckMark(1),"Chưa đánh dấu hoành thành nhiệm vụ");
