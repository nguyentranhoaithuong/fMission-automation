...
public class UTWF035 {
    ...
    public void Test() {
        ...
        fWorkflowPage.clickHoanThanhTaoNhiemVu();
        fWorkflowPage.clickHoanThanhButton();
        fWorkflowPage.clickXacNhanButton();
        ...
        softAssert.assertTrue(fWorkflowPage.isPopupCouponDisplayed());
        fWorkflowPage.closePopupCoupon();
        softAssert.assertTrue(fWorkflowPage.isTrangThaiHoanThanhDisplayed(nguoiThucHien));
        fWorkflowPage.openBangNhiemVu();
        softAssert.assertTrue(fWorkflowPage.isCheckMark(5),"Chưa đánh dấu hoành thành nhiệm vụ");
        softAssert.assertEquals(fWorkflowPage.getPhanTramHoanThanh(),"100%");
